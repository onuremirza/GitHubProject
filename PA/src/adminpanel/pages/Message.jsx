...
export default function Message() {
  return (
    <div class="p-5 h-screen w-full bg-gray-200">
      <h1 class="text-xl mb-2">Your Messages</h1>
      ...
      <table class="w-full">
        ...
        <tr>
          ...
          <th class="p-3 text-sm font-semibold tracking-wide text-left">Message</th>
          ...
          <th class="w-32 p-3 text-sm font-semibold tracking-wide text-left">Phone</th>
        </tr>
        </thead>
